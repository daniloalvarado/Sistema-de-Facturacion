...
<script>
	...
	$(document).ready(function() {
		...
		$('#add_item').click(function() {
			// Check if form_id (Producto/Servicio) is empty or has the default value
			...
			if ($('#qty').val() == '' || $('#unit').val() == '') {
				...
				// Agregar una clase de error para resaltar los campos vacíos
				$('#qty, #unit').addClass('border-primary');

				// Aplicar focus al primer campo vacío
				if ($('#unit').val() == '') {
					$('#unit').focus();
				} else {
					$('#qty').focus();
			...
			// Si los campos están completos, quitar la clase de error
