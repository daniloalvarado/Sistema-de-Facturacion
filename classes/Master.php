...
Class Master extends DBConnection {
	...
	function save_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Nueva Categoría Guardada");
			else
				$this->settings->set_flashdata('success',"Categoría Actualizada");
		}else{
			$resp['status'] = 'failed';
	...
	function delete_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Categoria Eliminada");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_product(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Nuevo Producto Guardado");
			else
				$this->settings->set_flashdata('success',"Producto Actualizado");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_product(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Producto Eliminado");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_service(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Nuevo Servicio Guardado");
			else
				$this->settings->set_flashdata('success',"Servicio Actualizado");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_service(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Servicio Eliminado");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_invoice(){
		...
		$this->settings->set_flashdata('success',"Factura Guardada");
		return json_encode($resp);
	}
	function delete_invoice(){
		...
		if($del && $del2){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Factura Eliminada");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
